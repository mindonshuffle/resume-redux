let name = "Scott Foster";
let skills = ["JavaScript", "HTML5", "CSS3", "Mongo", "Express", "React", "Node.js", "Git"];
let urls = ["about.me/thescottfoster", "linkedin.com/in/thescottfoster", "github.com/mindonshuffle"];
let email = ["thescottfoster@gmail.com"];
let location = ["Chicago, IL"];
let phoneNumber = "815.901.7884";

let bio = "Junior Web Developer seeking to leverage my lifelong passion for technology and established skills at problem-solving towards tackling new challenges and building new experiences."
...
let employment = [
    {
        employerName: "Freelance Photography",
        employmentDates: "Jun 2014 — Present",
        title: "Wedding, Event, and Portrait Photographer",
        details: null,
    },
    {
        employerName: "Resource Point of Sale",
        employmentDates: "Nov 2016 — Jul 2017",
    ...
    },
    {
        ...
        employmentDates: "Dec 2009 — Apr 2015",
    ...
    {
        employerName: "The Foster & Buick Law Group, LLC",
        employmentDates: "Jun 2006 — Aug 2010",
